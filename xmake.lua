target("spirv-tools")
    ...
    before_build(function(target)
        ...
        print("[spirv-tools] Generating SPIR-V tables with native Lua...")
        import("utils.gen_spirv_tables").generate(script_dir, out_dir)
        print("[spirv-tools] Done generating SPIR-V tables.")
    end)
